                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                          ...
                          <li class="nav-item">
                            ...
                            <a type="button" class="btn btn-sm btn-warning disabled m-0 me-4" href="<?= base_url() ?>home/detail_bulanan/<?= $detail->id_santri;?>">Bulanan</a>
                            <?php else : ?>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center">
                            ...
                            <tbody>
                                ...
                                $total_tagihan = 0;
                                $total_bayar = $this->db->select('sum(gross_amount) as total_bayar')->where(['id_santri' => $detail->id_santri, 'status_code' => 200])->get('tb_bayar_bulanan')->row()->total_bayar;
                                $tb = $total_bayar;
                                foreach ($data->result() as $key) :
                                    ...
                                    <tr class="<?php echo $lunas = ($bayar == $key->tagihan_bulanan) ? 'text-success' : ''; ?>">
