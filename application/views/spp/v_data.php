                    ...
                    <nav class="navbar navbar-expand-lg bg-gradient-success shadow-success border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                          ...
                          <li class="nav-item">
                            <a type="button" class="btn btn-sm btn-warning disabled m-0 me-4" href="">Tambahan</a>
                          </li>
                      ...
                      <a type="button" href="<?= base_url() ?>spp/form" class="btn btn-sm btn-info m-0 me-4">
                        Tambah
                    </a>
                    </nav>
                        ...
                        <tbody>
                            ...
                            foreach ($spp->result() as $key) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>spp/detail/<?= $key->id_spp ?>"><i class="fa fa-eye"></i></a>
                                    </td>
                                  <!--   <td>
                                        <a href="#" onclick="tambah('<?= $key->id_spp ?>', '<?= $key->jumlah ?>')"><i class="fa fa-plus"></i></a>
                                    </td> -->
                                    <td>
                                        <a href="#" class="edit" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="edit('<?= $key->id_spp ?>','<?= $key->ket ?>','<?= $key->jumlah ?>')"><i class="fa fa-edit"></i></a>
                                    </td>
                                    <td>
                                        <a href="#" onclick="hapus('<?= base_url() ?>spp/hapus/<?= $key->id_spp ?>', 'Apakah Anda Ingin Menghapus ..?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
...
<script>
   ...
   // }
    ...
    function edit(id, ket, jumlah) {
        $('#form_spp').attr('action', '<?= base_url() ?>spp/update/' + id);
        $('#ket').val(ket);
        $('#jumlah').val(jumlah);
    }
</script>