                    ...
                    <nav class="navbar navbar-expand-lg bg-gradient-success shadow-success border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                          ...
                          <li class="nav-item">
                            <a type="button" class="btn btn-sm btn-warning disabled m-0 me-4" href="<?= base_url() ?>tagihan/bulanan">Bulanan</a>
                          </li>
                          <li class="nav-item">
                            <a type="button" class="btn btn-sm btn-info m-0 me-4" href="<?= base_url() ?>tagihan/tahunan">Tahunan</a>
                          </li>
                          <li class="nav-item">
                     ...
                     <a type="button" href="<?= base_url() ?>tagihan/excel_bulanan" class="btn btn-sm btn-dark m-0 me-4">
                        export
                    </a>
                    </nav>
                    ...
                    <table class="table align-items-center">
                        ...
                        <tbody>
                            ...
                            foreach ($tagihan->result() as $key) :
                                $total_bayar = $this->db->select('sum(gross_amount) as total_bayar')->where(['id_santri' => $key->id_santri, 'status_code' => 200])->get('tb_bayar_bulanan')->row()->total_bayar;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>tagihan/detail_bulanan/<?= $key->id_santri ?>"><i class="fa fa-eye"></i></a>
                                    </td>
                                    <!-- <td>
...
<script>
    function bayar(id_santri, nama, tunggakan) {
        ...
        $('#form_bayar').attr('action', '<?= base_url() ?>tagihan/bayar_bulanan/' + id_santri);
